...
public class FrReservationRegister extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrReservationRegister
     */
    public FrReservationRegister() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrReservationRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrReservationRegister().setVisible(true);
            }
        });
    }
